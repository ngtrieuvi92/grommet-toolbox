...
config.plugins = [new _webpack2.default.HotModuleReplacementPlugin(), new _webpack2.default.DefinePlugin(env), new _webpackBundleAnalyzer.BundleAnalyzerPlugin()];
